    ...
    xyplayer.prototype = {
        ...
        xyplay: function (word, live, myplay)
        {
           ...
           //if(word!=="" && word.search(/\.m3u8/i)!==-1 ){word= this.host+"video/m3u8.php?url="+ encodeURIComponent(word)+"#.m3u8";}
			...
			console.log("xy url的内容："+url);
			console.log("xy Base64url的内容："+Base64.encode(url));
			this.farme(this.player,xieboq(_GET("boqid")) + Base64.encode(url));
...
/*设置播放器类型参数开始-------*/
//var boq_ip=_GET("boqid");
//console.log("noneid的内容："+xieboq(boq_ip))
     function xieboq(noneid){
		 console.log("noneid的内容："+noneid);
		 var boplay = '';
		 this.noneid = noneid;
		 this.boplay = boplay;
        if(this.noneid!==""){
		         this.boplay = "../player/?url="
                 console.log("noneid的内容："+noneid);
				 if(this.noneid=="dboq"){
					  this.boplay = "../player/?url="
					  console.log("noneid的内容name1："+this.boplay);}
				 if(this.noneid=="cboq"){
					  this.boplay = "../player/ckplayerx/?url="
					  console.log("noneid的内容name1："+this.boplay);}
				 if(this.noneid=="p2pboq"){
					  this.boplay = "../player/p2p-dplayer/?url="
					  console.log("noneid的内容name1："+this.boplay);}
				
                      } else {
					  this.boplay = "../player/?url="
					  console.log("noneid的内容name："+this.boplay);}
		 return this.boplay;
	 }
